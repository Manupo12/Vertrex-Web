      ...
      <div className="w-full max-w-sm rounded-xl border border-border bg-card p-6 shadow-2xl">
        ...
        {error && (
          <div className="mb-6 p-4 rounded-lg bg-red-500/10 text-red-500 text-sm text-center border border-red-500/20">
            {error === "1" ? "Credenciales invalidas. Intenta de nuevo." : error === "2" ? "Error del servidor. Revisa la conexion a la BD." : error === "3" ? "Demasiados intentos. Intenta en 1 minuto." : "Ocurrio un error al iniciar sesion."}
          </div>
        )}
